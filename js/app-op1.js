...
class BekiAppOp1 {
    ...
    // 1. EL GRANO DE CAFÉ (Para todos menos 3 y 5)
    obtenerSvgGrano() {
        return `
        <svg class="stamp-bean" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
    ...
    // 2. EL RAYO DE ENERGÍA (Para la posición 5)
    obtenerSvgBolt() {
        return `
        <svg class="stamp-bolt" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    // 3. LA PANADERÍA/MEDIALUNA (Para la posición 3)
    obtenerSvgBakery() {
        return `
